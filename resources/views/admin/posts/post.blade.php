            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Reastaurant">
                     </div>
                    <div class="form-group">
                        <label for="slug">Post Name</label>
                        <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter The restaurant name again please">
                    </div>
                </div>
                <div class="col-lg-6">
                  <br>
